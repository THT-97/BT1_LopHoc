...
public class TranHuyThinh_57131383_LopHoc {
    ...
    public static void main(String[] args) {
       ...
       //Tao GV 
        ...
        lop12.themGiaoVienGD((GiaoVien) gvGD1);
        lop12.themGiaoVienGD((GiaoVien) gvGD2);
        //ThemHS
        lop12.themHocSinh((HocSinh) hs1);
        lop12.themHocSinh((HocSinh) hs2);
        lop12.themHocSinh((HocSinh) hs3);
